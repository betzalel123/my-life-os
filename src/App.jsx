            ...
            <div className="lg:col-span-4 space-y-8">
              <section className="bg-white rounded-[2.5rem] p-7 shadow-sm border border-slate-200/60 relative overflow-hidden">
                ...
                <div className="grid grid-cols-2 gap-4 mb-5">
                  <div className="bg-rose-50 rounded-[1.8rem] p-5 text-center">
                    ...
                    <div className="text-[36px] xl:text-[42px] font-black text-rose-600 leading-none">
                      ₪0
                    </div>
                  </div>
                  <div className="bg-emerald-50 rounded-[1.8rem] p-5 text-center">
                    ...
                    <div className="text-[36px] xl:text-[42px] font-black text-emerald-700 leading-none">
                      ₪0
                    </div>
                  </div>
                </div>
              ...
              <section className="bg-white rounded-[2.5rem] p-7 shadow-sm border border-slate-200/60">
                ...
                <div className="rounded-[1.8rem] bg-indigo-50 border border-indigo-100 p-5 flex items-center justify-between">
                  ...
                  <div className="text-right flex-1 pr-4">
                    ...
                    <div className="text-indigo-500 font-black text-sm mt-1">
                      19:00 • עכשיו בביצוע
                    </div>
                  </div>
                </div>
              ...
              <section className="bg-white rounded-[2.5rem] p-7 shadow-sm border border-slate-200/60 min-h-[330px]">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <h2 className="text-[26px] xl:text-[30px] font-black text-slate-800">
                    Brain Dump
                  </h2>
                </div>
