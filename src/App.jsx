...
const App = () => {
  ...
  return (
    <div className="min-h-screen bg-[#f4f7fb] text-slate-900 font-sans pb-36" dir="rtl">
      ...
      <header className="sticky top-0 z-40 h-[92px] px-8 bg-white/90 backdrop-blur-xl border-b border-slate-200/70 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <button className="px-5 py-3 rounded-2xl bg-rose-50 border border-rose-100 text-rose-600 font-black text-lg flex items-center gap-3 shadow-sm hover:bg-rose-100 transition-all">
            <Heart size={18} fill="currentColor" /> הצלה
          </button>
      ...
      <main className="max-w-[1680px] mx-auto px-6 lg:px-10 py-10">
        {activeTab === 'dashboard' && (
                ...
                <div className="flex flex-col xl:flex-row xl:items-start justify-between gap-5 mb-8">
                  ...
                  <div className="flex items-center bg-slate-50 rounded-[2rem] border border-slate-200 p-2 gap-3">
                    ...
                    <div className="flex items-center gap-1 pr-1">
                      <button className="w-10 h-10 flex items-center justify-center text-indigo-500 hover:bg-white rounded-xl transition-all"><Dices size={20} /></button>
                      <button className="w-10 h-10 flex items-center justify-center text-amber-500 hover:bg-white rounded-xl transition-all"><Sparkles size={20} /></button>
                    </div>
                  </div>
                </div>
      ...
      {/* Navigation Dock */}
      <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 w-full max-w-[800px] px-4">
        <nav className="bg-[#182544] text-white rounded-[2.4rem] shadow-2xl px-5 py-3 flex items-center justify-between border border-white/5">
          {[
            ...
            <button
              ...
              className={`flex flex-col items-center justify-center gap-1.5 px-4 py-2.5 rounded-[1.8rem] transition-all min-w-[76px] ${
